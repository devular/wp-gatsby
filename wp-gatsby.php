...
final class WPGatsby
{
    ...
    private function setup_constants()
    {
        ...
        if (!defined('WPGATSBY_VERSION')) {
            define('WPGATSBY_VERSION', '1.0.11');
        }
...
<div class="error notice">
    <p><?php esc_html_e('WPGraphQL must be active for WPGatsby to work.', 'wp-gatsby'); ?>
        <a target="_blank"
            href="<?php echo esc_url('https://github.com/wp-graphql/wp-graphql/releases'); ?>">Download
